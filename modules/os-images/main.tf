locals {
  os = {
    ...
    "amazonlinux" = {
      "latest"   = "https://cdn.amazonlinux.com/al2023/os-images/2023.7.20250414.0/kvm/al2023-kvm-2023.7.20250414.0-kernel-6.1-x86_64.xfs.gpt.qcow2",
      "2023"     = "https://cdn.amazonlinux.com/al2023/os-images/2023.7.20250414.0/kvm/al2023-kvm-2023.7.20250414.0-kernel-6.1-x86_64.xfs.gpt.qcow2"
    },
    "opensuse" = {
